...
void WorldSimulator::AgentArrayCallback(msg_builder::TrafficAgentArray data) {
    ...
    if (MopedParams::PHONG_DEBUG)
        logi << "[PHONG] WorldSimulator::AgentArrayCallback" << endl;
    ...
    for (msg_builder::TrafficAgent& agent : data.agents) {
        ...
        //logi << "[PHONG] AgentArrayCallback exo_agents_ id: " << id << " x: " << exo_agents_[id].pos.x << " y: " << exo_agents_[id].pos.y << endl;
...
void WorldSimulator::AgentPathArrayCallback(msg_builder::AgentPathArray data) {
    ...
    if (MopedParams::PHONG_DEBUG)
        logi << "[PHONG] WorldSimulator::AgentPathArrayCallback" << endl;
...
void WorldSimulator::EgoStateCallBack(
    ...
    if (MopedParams::PHONG_DEBUG)
        logi << "[PHONG] EgoStateCallback car_: x: " << car_.pos.x << " y: " << car_.pos.y << endl;
