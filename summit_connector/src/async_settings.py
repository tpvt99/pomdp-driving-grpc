...
## 35 times slower (lanegcn/hivt)

#EGO_VEHICLE_UPDATE_FREQUENCY_IN_HZ = 0.5714 #20, if 10 times slower, use 2

## 50 times slower (same Hz)

#EGO_VEHICLE_UPDATE_FREQUENCY_IN_HZ = 0.4 #20, if 10 times slower, use 2

## 60 times slower (same Hz)

#EGO_VEHICLE_UPDATE_FREQUENCY_IN_HZ = 0.333 #20, if 10 times slower, use 2

## 100 times slower (same Hz)

#EGO_VEHICLE_UPDATE_FREQUENCY_IN_HZ = 0.2 #20, if 10 times slower, use 2

## 150 times slower (same Hz)

#EGO_VEHICLE_UPDATE_FREQUENCY_IN_HZ = 0.1333 #20, if 10 times slower, use 2
...
## 3000 times slower (same Hz)

#EGO_VEHICLE_UPDATE_FREQUENCY_IN_HZ = 0.00667 #20, if 10 times slower, use 2
