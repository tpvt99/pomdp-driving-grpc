...
class EgoVehicle(Summit):
    ...
    def send_control_from_vel(self):
        ...
        if cmd_speed < 1e-5 and cur_speed < 0.5:
            ...
            #if PRINT_LOG:
            print('{} [PHONG] Ego_vehicle.py dt {}, speed_error {}, cmd_sp {} curr_sp {} cmd_st {} throttle {}, steer {}'.format(
            output_time(), dt, round(speed_error,2), round(cmd_speed, 2), round(cur_speed,2), 
            round(cmd_steer, 2), round(control.throttle, 2), round(control.steer, 2)))
