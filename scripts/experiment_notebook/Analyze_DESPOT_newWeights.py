...
def get_normalized_data(method, prediction_performance, driving_performance, max_min_method, prediction_metric):
    ...
    #print(f"efficiency {efficiency_data} safety {safety_data} and comfort {comfort_data}")
...
def plot_dynamic_vs_staticade_scatter(prediction_performance_map, methods_to_plot):
    ...
    for which_dynamic_ade in dynamic_ade_dict.keys():
        ...
        plt.ylim(top=max(dynamic_ade_dict[which_dynamic_ade])*1.05)  # Adjust the ylim to provide more space for the legend
...
def plot_static_ade_vs_driving_performance(prediction_performance_map, 
    ...
    for performance_metric in ['driving', 'safety', 'efficiency', 'comfort']:
        ...
        plt.savefig(f"D_Static_{metric}_vs_{performance_metric.capitalize()}_Performance_DESPOT.pdf", dpi=300)
        plt.clf()
        plt.close()
...
def plot_dynamic_ade_vs_driving_performance(prediction_performance_map, 
    ...
    metric = 'ade_obs20_closest_predlen30'
    ...
    plt.grid(True, linewidth=0.5, alpha=0.7)
    plt.savefig(f"D2_Dynamic_{metric}_vs_Driving_Performance_DESPOT.pdf", dpi=300)
    plt.clf()
...
if __name__ == "__main__":
    ...
    #plot_dynamic_vs_staticade_scatter(prediction_performance_DESPOT, list(directories_map_DESPOT.keys()))
