...
# Print the path of the Summit module
print("In side ego vehicle to print summit path: " , inspect.getfile(summit_module))
...
from agent_history import History
...
class EgoVehicle(Summit):
    def __init__(self):
        ...
        moped_pyro_port = rospy.get_param('~moped_pyro_port', '8300')
        ...
        self.moped_service = Pyro4.Proxy('PYRO:mopedservice.warehouse@localhost:{}'.format(moped_pyro_port))
        ...
        try:
            self.world.wait_for_tick()  # Wait for collision to be applied.
        except:
            pass
        ...
        #self.draw_waypoints(values, self.world, color=carla.Color(r=0, g=255, b=0), life_time=120)
    ...
    def update(self):
        ...
        #     print("Updating control by GAMMA")
...
if __name__ == '__main__':
    ...
    print('{} [PHONG] Running ego_vehicle_gammapy3.py inside new folder gamma_planner'.format(output_time()))
    ...
    rate = rospy.Rate(EGO_VEHICLE_UPDATE_FREQUENCY_IN_HZ)
